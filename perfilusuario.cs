...
namespace GeneXus.Programs {
   public class perfilusuario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public perfilusuario( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("perfilusuario.aspx") +"\">") ;
      ...
      {
         return formatLink("perfilusuario.aspx")  ;
      }
      ...
      protected void START142( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Perfil Usuario", 0) ;
         }
         context.wjLoc = "";
