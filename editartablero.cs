...
namespace GeneXus.Programs {
   public class editartablero : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public editartablero( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20229920474556", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTABLEROS", AV9Tableros);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTABLEROS", AV9Tableros);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSDT_SA", AV6sdt_sa);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSDT_SA", AV6sdt_sa);
         }
      }
      ...
      {
         return "EditarTablero" ;
      }

      public override string GetPgmdesc( )
      {
         return "Editar Tablero" ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 75, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EditarTablero.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, lblTextblock1_Caption, "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 1, "HLP_EditarTablero.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTableronombre_Internalname, StringUtil.RTrim( AV8TableroNombre), StringUtil.RTrim( context.localUtil.Format( AV8TableroNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,17);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTableronombre_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTableronombre_Enabled, 0, "text", "", 100, "%", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EditarTablero.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavTablerovisibilidad, cmbavTablerovisibilidad_Internalname, StringUtil.BoolToStr( AV10TableroVisibilidad), 1, cmbavTablerovisibilidad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "boolean", "", 1, cmbavTablerovisibilidad.Enabled, 0, 0, 100, "%", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "", true, 1, "HLP_EditarTablero.htm");
            cmbavTablerovisibilidad.CurrentValue = StringUtil.BoolToStr( AV10TableroVisibilidad);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGuardar_Internalname, "", "Guardar", bttGuardar_Jsonclick, 5, "Guardar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GUARDAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EditarTablero.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'',0)\"";
            ClassString = "BtnCancel";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancelar_Internalname, "", "Cancelar", bttCancelar_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCELAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EditarTablero.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
      ...
      protected void START0P2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Editar Tablero", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV10TableroVisibilidad = StringUtil.StrToBool( cmbavTablerovisibilidad.getValidValue(StringUtil.BoolToStr( AV10TableroVisibilidad)));
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8TableroNombre = cgiGet( edtavTableronombre_Internalname);
            AssignAttri("", false, "AV8TableroNombre", AV8TableroNombre);
            cmbavTablerovisibilidad.CurrentValue = cgiGet( cmbavTablerovisibilidad_Internalname);
            AV10TableroVisibilidad = StringUtil.StrToBool( cgiGet( cmbavTablerovisibilidad_Internalname));
            AssignAttri("", false, "AV10TableroVisibilidad", AV10TableroVisibilidad);
      ...
      protected void E110P2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblTextblock1_Caption = "<h2><center></strong>Editar el tablero</strong></center></h2>";
         AssignProp("", false, lblTextblock1_Internalname, "Caption", lblTextblock1_Caption, true);
         AV9Tableros.Load(A9TableroId);
         AV8TableroNombre = AV9Tableros.gxTpr_Tableronombre;
         AssignAttri("", false, "AV8TableroNombre", AV8TableroNombre);
         AV10TableroVisibilidad = AV9Tableros.gxTpr_Tablerovisibilidad;
         AssignAttri("", false, "AV10TableroVisibilidad", AV10TableroVisibilidad);
      }
      ...
      protected void E130P2( )
      {
         ...
         returnInSub = false;
         AV5count = 0;
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV8TableroNombre)) )
         {
         ...
         if ( AV5count == 0 )
         {
            AV9Tableros.gxTpr_Tableronombre = AV8TableroNombre;
            AV9Tableros.gxTpr_Tableroestado = true;
            AV9Tableros.gxTpr_Tablerofechacreacion = DateTimeUtil.ServerNow( context, pr_default);
            AV9Tableros.gxTpr_Tablerovisibilidad = AV10TableroVisibilidad;
            AV9Tableros.gxTpr_Propietarioid = (short)(NumberUtil.Val( AV11websession.Get("UsuarioId"), "."));
            AV9Tableros.Save();
            if ( AV9Tableros.Success() )
            {
               context.CommitDataStores("editartablero",pr_default);
               AV6sdt_sa.gxTpr_Title = "Tablero guardado correctamente";
               AV6sdt_sa.gxTpr_Html = "La edición del tablero fue hecha correctamente";
               AV6sdt_sa.gxTpr_Timer = 4000;
               AV6sdt_sa.gxTpr_Allowoutsideclick = true;
               AV6sdt_sa.gxTpr_Type = "success";
               this.executeUsercontrolMethod("", false, "RAMP_ADDONS_SWEETALERT1Container", "msgSW", "", new Object[] {(SdtSDT_SweetAlert)AV6sdt_sa});
               context.setWebReturnParms(new Object[] {(short)A9TableroId});
               context.setWebReturnParmsMetadata(new Object[] {"A9TableroId"});
               context.wjLocDisableFrm = 1;
               context.nUserReturn = 1;
            ...
            {
               context.RollbackDataStores("editartablero",pr_default);
               AV6sdt_sa.gxTpr_Title = "Ha ocurrido un error";
               AV6sdt_sa.gxTpr_Html = "Ha ocurrido un error, por favor intentelo nuevamente";
               AV6sdt_sa.gxTpr_Timer = 4000;
               AV6sdt_sa.gxTpr_Allowoutsideclick = true;
               AV6sdt_sa.gxTpr_Type = "error";
               this.executeUsercontrolMethod("", false, "RAMP_ADDONS_SWEETALERT1Container", "msgSW", "", new Object[] {(SdtSDT_SweetAlert)AV6sdt_sa});
               context.setWebReturnParms(new Object[] {(short)A9TableroId});
               context.setWebReturnParmsMetadata(new Object[] {"A9TableroId"});
               context.wjLocDisableFrm = 1;
         ...
         {
            AV6sdt_sa.gxTpr_Title = "Error en la información ingresada";
            AV6sdt_sa.gxTpr_Html = "Por favor verifica los errores y corrígelos para continuar";
            AV6sdt_sa.gxTpr_Timer = 4000;
            AV6sdt_sa.gxTpr_Allowoutsideclick = true;
            AV6sdt_sa.gxTpr_Type = "error";
            this.executeUsercontrolMethod("", false, "RAMP_ADDONS_SWEETALERT1Container", "msgSW", "", new Object[] {(SdtSDT_SweetAlert)AV6sdt_sa});
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV9Tableros", AV9Tableros);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV6sdt_sa", AV6sdt_sa);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20229920474570", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("editartablero.js", "?20229920474570", false, true);
         context.AddJavascriptSource("RAMP/sweetAlert/js/sweetalert2.min.js", "", false, true);
         context.AddJavascriptSource("RAMP/shared/js/jquery-3.5.1.min.js", "", false, true);
         context.AddJavascriptSource("RAMP/shared/js/popper.js", "", false, true);
         context.AddJavascriptSource("RAMP/shared/js/bootstrap.min.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CANCELAR'","{handler:'E120P2',iparms:[{av:'A9TableroId',fld:'TABLEROID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'CANCELAR'",",oparms:[]}");
         setEventMetadata("'GUARDAR'","{handler:'E130P2',iparms:[{av:'AV8TableroNombre',fld:'vTABLERONOMBRE',pic:''},{av:'AV9Tableros',fld:'vTABLEROS',pic:''},{av:'cmbavTablerovisibilidad'},{av:'AV10TableroVisibilidad',fld:'vTABLEROVISIBILIDAD',pic:''},{av:'AV6sdt_sa',fld:'vSDT_SA',pic:''},{av:'A9TableroId',fld:'TABLEROID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'GUARDAR'",",oparms:[{av:'AV9Tableros',fld:'vTABLEROS',pic:''},{av:'AV6sdt_sa',fld:'vSDT_SA',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.editartablero__default(),
            new Object[][] {
                new Object[] {
               H000P2_A9TableroId
               }
      ...
      private string AV8TableroNombre ;
      ...
      private bool wbLoad ;
      private bool AV10TableroVisibilidad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private short[] H000P2_A9TableroId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
      private SdtSDT_SweetAlert AV6sdt_sa ;
      private SdtTableros AV9Tableros ;
   }

   public class editartablero__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000P2", "SELECT [TableroId] FROM [Tableros] WHERE [TableroId] = @TableroId ORDER BY [TableroId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
