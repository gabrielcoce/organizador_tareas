...
namespace GeneXus.Programs {
   public class gx0090 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV11cActividadEstado = (short)(NumberUtil.Val( GetPar( "cActividadEstado"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cTableroId, AV7cTareaId, AV8cActividadId, AV9cActividadNombre, AV10cActividadAvance, AV11cActividadEstado) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20229920475614", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCACTIVIDADESTADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cActividadEstado), 1, 0, ",", "")));
         /* Send saved values. */
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCactividadestado_Internalname, "Actividad Estado", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'" + sGXsfl_74_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCactividadestado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cActividadEstado), 1, 0, ",", "")), StringUtil.LTrim( ((edtavCactividadestado_Enabled!=0) ? context.localUtil.Format( (decimal)(AV11cActividadEstado), "9") : context.localUtil.Format( (decimal)(AV11cActividadEstado), "9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCactividadestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCactividadestado_Visible, edtavCactividadestado_Enabled, 0, "text", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e170e1_client"+"'", TempTags, "", 2, "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A33ActividadEstado), 1, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
         ...
         if ( wbEnd == 74 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCACTIVIDADESTADO"), ",", ".") != Convert.ToDecimal( AV11cActividadEstado )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000E2 */
            pr_default.execute(0, new Object[] {AV6cTableroId, AV7cTareaId, AV8cActividadId, lV9cActividadNombre, AV10cActividadAvance, AV11cActividadEstado, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_74_idx = 1;
            sGXsfl_74_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_74_idx), 4, 0), 4, "0");
            SubsflControlProps_742( ) ;
      ...
      protected void send_integrity_lvl_hashes0E2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TAREAID"+"_"+sGXsfl_74_idx, GetSecureSignedToken( sGXsfl_74_idx, context.localUtil.Format( (decimal)(A12TareaId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ACTIVIDADID"+"_"+sGXsfl_74_idx, GetSecureSignedToken( sGXsfl_74_idx, context.localUtil.Format( (decimal)(A30ActividadId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV9cActividadNombre = StringUtil.PadR( StringUtil.RTrim( AV9cActividadNombre), 20, "%");
         /* Using cursor H000E3 */
         pr_default.execute(1, new Object[] {AV6cTableroId, AV7cTareaId, AV8cActividadId, lV9cActividadNombre, AV10cActividadAvance, AV11cActividadEstado});
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCactividadestado_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCactividadestado_Internalname), ",", ".") > Convert.ToDecimal( 9 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vCACTIVIDADESTADO");
               GX_FocusControl = edtavCactividadestado_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV11cActividadEstado = 0;
               AssignAttri("", false, "AV11cActividadEstado", StringUtil.Str( (decimal)(AV11cActividadEstado), 1, 0));
            }
            else
            {
               AV11cActividadEstado = (short)(context.localUtil.CToN( cgiGet( edtavCactividadestado_Internalname), ",", "."));
               AssignAttri("", false, "AV11cActividadEstado", StringUtil.Str( (decimal)(AV11cActividadEstado), 1, 0));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20229920475653", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0090.js", "?20229920475654", false, true);
      ...
      protected void SubsflControlProps_742( )
      {
         ...
         edtActividadId_Internalname = "ACTIVIDADID_"+sGXsfl_74_idx;
         edtActividadNombre_Internalname = "ACTIVIDADNOMBRE_"+sGXsfl_74_idx;
         edtActividadAvance_Internalname = "ACTIVIDADAVANCE_"+sGXsfl_74_idx;
         edtActividadEstado_Internalname = "ACTIVIDADESTADO_"+sGXsfl_74_idx;
      }
      ...
      protected void SubsflControlProps_fel_742( )
      {
         ...
         edtActividadId_Internalname = "ACTIVIDADID_"+sGXsfl_74_fel_idx;
         edtActividadNombre_Internalname = "ACTIVIDADNOMBRE_"+sGXsfl_74_fel_idx;
         edtActividadAvance_Internalname = "ACTIVIDADAVANCE_"+sGXsfl_74_fel_idx;
         edtActividadEstado_Internalname = "ACTIVIDADESTADO_"+sGXsfl_74_fel_idx;
      }
      ...
      protected void sendrow_742( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_74_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, edtActividadNombre_Internalname, "Link", edtActividadNombre_Link, !bGXsfl_74_Refreshing);
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtActividadEstado_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A33ActividadEstado), 1, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A33ActividadEstado), "9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtActividadEstado_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)1,(short)0,(short)0,(short)74,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
      ...
      protected void init_default_properties( )
      {
         ...
         edtavCactividadestado_Internalname = "vCACTIVIDADESTADO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCactividadestado_Jsonclick = "";
         edtavCactividadestado_Enabled = 1;
         edtavCactividadestado_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTableroId',fld:'vCTABLEROID',pic:'ZZZ9'},{av:'AV7cTareaId',fld:'vCTAREAID',pic:'ZZZ9'},{av:'AV8cActividadId',fld:'vCACTIVIDADID',pic:'ZZZ9'},{av:'AV9cActividadNombre',fld:'vCACTIVIDADNOMBRE',pic:''},{av:'AV10cActividadAvance',fld:'vCACTIVIDADAVANCE',pic:'ZZ9'},{av:'AV11cActividadEstado',fld:'vCACTIVIDADESTADO',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E170E1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         ...
         setEventMetadata("LBLACTIVIDADESTADOFILTER.CLICK",",oparms:[{av:'divActividadestadofiltercontainer_Class',ctrl:'ACTIVIDADESTADOFILTERCONTAINER',prop:'Class'},{av:'edtavCactividadestado_Visible',ctrl:'vCACTIVIDADESTADO',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E200E2',iparms:[{av:'A9TableroId',fld:'TABLEROID',pic:'ZZZ9',hsh:true},{av:'A12TareaId',fld:'TAREAID',pic:'ZZZ9',hsh:true},{av:'A30ActividadId',fld:'ACTIVIDADID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Actividadestado',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV9cActividadNombre = "";
         H000E2_A33ActividadEstado = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0090__default(),
            new Object[][] {
                new Object[] {
               H000E2_A33ActividadEstado, H000E2_A32ActividadAvance, H000E2_A31ActividadNombre, H000E2_A30ActividadId, H000E2_A12TareaId, H000E2_A9TableroId
               }
               , new Object[] {
      ...
      private short AV11cActividadEstado ;
      ...
      private int edtavCactividadestado_Enabled ;
      private int edtavCactividadestado_Visible ;
      ...
      private string edtavCactividadestado_Internalname ;
      private string edtavCactividadestado_Jsonclick ;
      ...
      private short[] H000E2_A33ActividadEstado ;
   ...
   public class gx0090__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8cActividadId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ActividadEstado], [ActividadAvance], [ActividadNombre], [ActividadId], [TareaId], [TableroId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000E2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H000E3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV11cActividadEstado",GXType.Int16,1,0) ,
